...
async function handleMain(req, res) {
  ...
  try {
    ...
    // 시술 선택 → 바로 캘린더
    const bookingKeywords = ["레이저토닝 예약하기", "보톡스 예약하기", "수분리프팅 예약하기", "피부클리닉 예약하기", "무료상담 예약하기", "필러 예약하기", "리프팅 예약하기", "제모 예약하기", "스킨부스터 예약하기", "여드름흉터 예약하기", "김연세 원장으로 예약하기", "박푸르미 원장으로 예약하기", "이미소 원장으로 예약하기"];
    // 예약 방식 선택
