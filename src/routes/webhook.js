...
const INDUSTRIES = {
  ko: [
    ...
    { title: '💉 성형외과', desc: '자연스럽고 아름다운 성형', msg: '성형외과', img: 'banner_plastic.jpg' },
    { title: '🔬 비뇨기과', desc: '전문의와 함께하는 비뇨기 건강', msg: '비뇨기과', img: 'banner_urology.jpg' },
    { title: '🤰 산부인과', desc: '여성 건강을 위한 전문 진료', msg: '산부인과', img: 'banner_obgyn.jpg' },
    { title: '💙 정신건강의학과', desc: '마음 건강을 위한 전문 상담', msg: '정신과', img: 'banner_psychiatry.jpg' },
  ...
  en: [
    ...
    { title: '💉 Plastic Surgery', desc: 'Natural & beautiful results', msg: '성형외과', img: 'banner_plastic.jpg' },
    { title: '🔬 Urology', desc: 'Urological health care', msg: '비뇨기과', img: 'banner_urology.jpg' },
    { title: '🤰 OB/GYN', desc: 'Women health specialist', msg: '산부인과', img: 'banner_obgyn.jpg' },
    { title: '💙 Psychiatry', desc: 'Mental health counseling', msg: '정신과', img: 'banner_psychiatry.jpg' },
...
async function showWelcome(callbackUrl, lang = 'ko', industry = 'hospital') {
  ...
  try {
    ...
    const bannerUrl = `${BASE_URL}/banner_${industry === 'obesity' ? 'obesity_v2' : industry}.jpg`;
    const welcomeMsgs = {
    ...
    const symptomMapAll = {
      ko: {
        ...
        plastic: [
          ...
          { title: '👃 코가 낮거나 마음에 안 든다', desc: '코성형·콧대·코끝\n자연스러운 코 성형', msg: '증상상담:코가 낮거나 마음에 안 든다' },
          { title: '😊 얼굴 윤곽이 고민이다', desc: '윤곽·광대·턱·페이스라인\n윤곽 성형', msg: '증상상담:얼굴 윤곽이 고민이다' },
          { title: '💉 보톡스·필러가 궁금하다', desc: '주름·볼륨·리프팅\n비수술 시술', msg: '증상상담:보톡스와 필러가 궁금하다' },
          { title: '🏋️ 가슴 성형이 고민이다', desc: '가슴확대·축소·리프팅\n가슴 성형', msg: '증상상담:가슴 성형이 고민이다' },
        ],
        urology: [
      ...
      en: {
        hospital: [
          { title: '😣 I have a lot of acne', desc: 'Face/back/chest acne\nSebum & pore issues', msg: '증상상담:여드름이 많이 난다' },
          { title: '🌑 My skin looks dull with pigmentation', desc: 'Melasma·dark spots\nSkin tone improvement', msg: '증상상담:피부가 칙칙하고 색소가 생겼다' },
          { title: '📉 I have wrinkles and sagging skin', desc: 'Aging·wrinkles·elasticity\nLifting needed', msg: '증상상담:주름이 늘고 피부가 처진다' },
          { title: '🔴 My skin is red and troubled', desc: 'Redness·sensitive·trouble\nSkin calming needed', msg: '증상상담:피부가 붉고 트러블이 심하다' },
          { title: '🕳️ I have enlarged pores and rough skin', desc: 'Pores·skin texture·dead skin\nSkin care needed', msg: '증상상담:모공이 넓고 피부결이 거칠다' },
          { title: '⚫ I am bothered by moles or scars', desc: 'Moles·scars·acne marks\nRemoval consultation', msg: '증상상담:점과 흉터가 신경 쓰인다' },
        ],
        plastic: [
          { title: '👁️ My eyes are small or I have no double eyelids', desc: 'Double eyelid·eye correction\nNatural eye surgery', msg: '증상상담:눈이 작거나 쌍꺼풀이 없다' },
          { title: '👃 My nose is flat or I dislike it', desc: 'Nose surgery·bridge·tip\nNatural nose surgery', msg: '증상상담:코가 낮거나 마음에 안 든다' },
          { title: '😊 I am concerned about my facial contour', desc: 'Contour·cheekbone·jaw\nFacial contouring', msg: '증상상담:얼굴 윤곽이 고민이다' },
          { title: '💉 I am curious about Botox and fillers', desc: 'Wrinkles·volume·lifting\nNon-surgical treatment', msg: '증상상담:보톡스와 필러가 궁금하다' },
          { title: '🏋️ I am considering breast surgery', desc: 'Augmentation·reduction·lifting\nBreast surgery', msg: '증상상담:가슴 성형이 고민이다' },
        ],
        urology: [
          { title: '🚽 I need to urinate frequently', desc: 'Frequent urination·overactive bladder\nPossible prostate issue', msg: '증상상담:소변이 자주 마렵다' },
          { title: '😣 I have pain when urinating', desc: 'UTI·cystitis\nSpecialist diagnosis needed', msg: '증상상담:소변볼 때 통증이 있다' },
          { title: '💪 I am worried about men\'s health', desc: 'Male function·hormones\nUrological health consultation', msg: '증상상담:남성 건강이 걱정된다' },
          { title: '🔬 I am worried about my prostate', desc: 'BPH·prostate cancer\nRegular checkup recommended', msg: '증상상담:전립선이 걱정된다' },
        ],
        obgyn: [
          { title: '📅 My period is irregular', desc: 'Irregular period·amenorrhea\nHormonal imbalance', msg: '증상상담:생리가 불규칙하다' },
          { title: '🤰 I am preparing for pregnancy', desc: 'Prenatal checkup·infertility\nPregnancy preparation', msg: '증상상담:임신 준비 중이다' },
          { title: '🌡️ I have menopause symptoms', desc: 'Hot flashes·insomnia·depression\nMenopause treatment', msg: '증상상담:갱년기 증상이 있다' },
          { title: '💊 I have vaginitis or discharge', desc: 'Vaginitis·discharge·itching\nWomen\'s health consultation', msg: '증상상담:질염과 냉대하가 있다' },
        ],
        psychiatry: [
          { title: '😔 I feel depressed and lethargic', desc: 'Depression·lethargy\nSpecialist consultation needed', msg: '증상상담:우울하고 무기력하다' },
          { title: '😰 I feel anxious and have panic attacks', desc: 'Anxiety disorder·panic attack\nPanic disorder treatment', msg: '증상상담:불안하고 공황이 온다' },
          { title: '😴 I cannot sleep well', desc: 'Insomnia·sleep disorder\nSleep treatment consultation', msg: '증상상담:잠을 잘 못 잔다' },
          { title: '🧠 I cannot concentrate and feel scattered', desc: 'ADHD·concentration issues\nDetailed examination', msg: '증상상담:집중이 안 되고 산만하다' },
          { title: '😤 I am under a lot of stress', desc: 'Burnout·stress\nPsychological consultation needed', msg: '증상상담:스트레스가 심하다' },
        ],
        dental: [
          { title: '🥶 My teeth are sensitive and painful', desc: 'Cavity·root canal·sensitivity\nQuick treatment needed', msg: '증상상담:치아가 시리고 아프다' },
          { title: '🩸 My gums are swollen and bleeding', desc: 'Gingivitis·periodontitis\nGum treatment needed', msg: '증상상담:잇몸이 붓고 피가 난다' },
          { title: '😬 My teeth are not straight', desc: 'Orthodontics·crowded teeth\nBraces consultation', msg: '증상상담:치아가 고르지 않다' },
          { title: '🦷 I need an implant', desc: 'Missing teeth·implant\nImplant consultation', msg: '증상상담:임플란트가 필요하다' },
          { title: '🟡 My teeth are yellow', desc: 'Tooth discoloration·whitening\nWhitening treatment', msg: '증상상담:치아가 누렇다' },
        ],
        obesity: [
          { title: '🍔 I am concerned about belly fat', desc: 'Abdomen·belly fat·visceral fat\nLiposuction·LAMS consultation', msg: '증상상담:복부 살이 고민이다' },
          { title: '💪 I am concerned about thick arms', desc: 'Arm fat\nLAMS·liposuction consultation', msg: '증상상담:팔뚝이 굵어서 고민이다' },
          { title: '🦵 I am concerned about thick thighs', desc: 'Thigh·calf fat\nLAMS·liposuction consultation', msg: '증상상담:허벅지가 두꺼워서 고민이다' },
          { title: '😓 I diet but cannot lose weight', desc: 'Localized fat·yo-yo\nNon-surgical LAMS', msg: '증상상담:다이어트를 해도 살이 안 빠진다' },
          { title: '👗 A specific body part bothers me when dressing', desc: 'Body shaping·body line\nLocalized fat removal', msg: '증상상담:옷 입을 때 특정 부위가 신경 쓰인다' },
          { title: '🔬 I want to remove fat without surgery', desc: 'Non-surgical LAMS\n10-min procedure·no incision', msg: '증상상담:수술 없이 지방을 빼고 싶다' },
        ],
      },
      zh: {
        hospital: [
          { title: '😣 我长了很多痘痘', desc: '面部·背部痘痘\n皮脂·毛孔问题', msg: '증상상담:여드름이 많이 난다' },
          { title: '🌑 皮肤暗沉有色斑', desc: '黄褐斑·色素沉着\n肤色改善', msg: '증상상담:피부가 칙칙하고 색소가 생겼다' },
          { title: '📉 皱纹增多皮肤松弛', desc: '老化·皱纹·弹性下降\n提升需要', msg: '증상상담:주름이 늘고 피부가 처진다' },
          { title: '🔴 皮肤发红问题严重', desc: '红血丝·敏感肌·痘痘\n皮肤镇静需要', msg: '증상상담:피부가 붉고 트러블이 심하다' },
          { title: '🕳️ 毛孔粗大皮肤粗糙', desc: '毛孔·肤质·角质\n护肤需要', msg: '증상상담:모공이 넓고 피부결이 거칠다' },
          { title: '⚫ 痣和疤痕让我烦恼', desc: '痣·疤痕·痘印\n去除咨询', msg: '증상상담:점과 흉터가 신경 쓰인다' },
        ],
        plastic: [
          { title: '👁️ 眼睛小或没有双眼皮', desc: '双眼皮·眼型矫正\n自然眼部整形', msg: '증상상담:눈이 작거나 쌍꺼풀이 없다' },
          { title: '👃 鼻子低或不满意', desc: '鼻部整形·鼻梁·鼻尖\n自然鼻部整形', msg: '증상상담:코가 낮거나 마음에 안 든다' },
          { title: '😊 对脸部轮廓有烦恼', desc: '轮廓·颧骨·下巴\n轮廓整形', msg: '증상상담:얼굴 윤곽이 고민이다' },
          { title: '💉 想了解肉毒素和填充', desc: '皱纹·丰盈·提升\n非手术治疗', msg: '증상상담:보톡스와 필러가 궁금하다' },
          { title: '🏋️ 考虑胸部整形', desc: '隆胸·缩胸·提升\n胸部整形', msg: '증상상담:가슴 성형이 고민이다' },
        ],
        urology: [
          { title: '🚽 尿频', desc: '频尿·过度活跃膀胱\n可能有前列腺问题', msg: '증상상담:소변이 자주 마렵다' },
          { title: '😣 排尿时疼痛', desc: '尿路感染·膀胱炎\n需要专科诊断', msg: '증상상담:소변볼 때 통증이 있다' },
          { title: '💪 担心男性健康', desc: '男性功能·荷尔蒙\n泌尿健康咨询', msg: '증상상담:남성 건강이 걱정된다' },
          { title: '🔬 担心前列腺', desc: '前列腺增生·前列腺癌\n建议定期检查', msg: '증상상담:전립선이 걱정된다' },
        ],
        obgyn: [
          { title: '📅 月经不规律', desc: '月经不调·闭经\n荷尔蒙失衡', msg: '증상상담:생리가 불규칙하다' },
          { title: '🤰 正在备孕', desc: '产前检查·不孕\n备孕咨询', msg: '증상상담:임신 준비 중이다' },
          { title: '🌡️ 有更年期症状', desc: '潮热·失眠·抑郁\n更年期治疗咨询', msg: '증상상담:갱년기 증상이 있다' },
          { title: '💊 有阴道炎或分泌物', desc: '阴道炎·分泌物·瘙痒\n女性健康咨询', msg: '증상상담:질염과 냉대하가 있다' },
        ],
        psychiatry: [
          { title: '😔 感到抑郁和无力', desc: '抑郁症·无力·意欲低下\n需要专科咨询', msg: '증상상담:우울하고 무기력하다' },
          { title: '😰 感到焦虑和恐慌', desc: '焦虑障碍·恐慌发作\n恐慌症治疗', msg: '증상상담:불안하고 공황이 온다' },
          { title: '😴 睡眠不好', desc: '失眠·睡眠障碍\n睡眠治疗咨询', msg: '증상상담:잠을 잘 못 잔다' },
          { title: '🧠 注意力不集中', desc: 'ADHD·注意力下降\n精密检查咨询', msg: '증상상담:집중이 안 되고 산만하다' },
          { title: '😤 压力很大', desc: '倦怠·压力\n需要心理咨询', msg: '증상상담:스트레스가 심하다' },
        ],
        dental: [
          { title: '🥶 牙齿敏感疼痛', desc: '蛀牙·根管治疗·敏感\n需要尽快就诊', msg: '증상상담:치아가 시리고 아프다' },
          { title: '🩸 牙龈肿胀出血', desc: '牙龈炎·牙周炎\n需要牙龈治疗', msg: '증상상담:잇몸이 붓고 피가 난다' },
          { title: '😬 牙齿不整齐', desc: '牙齿矫正·畸齿\n矫正咨询', msg: '증상상담:치아가 고르지 않다' },
          { title: '🦷 需要种植牙', desc: '缺牙·种植牙\n种植牙咨询', msg: '증상상담:임플란트가 필요하다' },
          { title: '🟡 牙齿发黄', desc: '牙齿变色·美白\n美白治疗咨询', msg: '증상상담:치아가 누렇다' },
        ],
        obesity: [
          { title: '🍔 腹部赘肉让我烦恼', desc: '腹部·腹部脂肪·内脏脂肪\n吸脂·LAMS咨询', msg: '증상상담:복부 살이 고민이다' },
          { title: '💪 手臂粗让我烦恼', desc: '手臂脂肪\nLAMS·吸脂咨询', msg: '증상상담:팔뚝이 굵어서 고민이다' },
          { title: '🦵 大腿粗让我烦恼', desc: '大腿·小腿脂肪\nLAMS·吸脂咨询', msg: '증상상담:허벅지가 두꺼워서 고민이다' },
          { title: '😓 节食也瘦不下来', desc: '局部脂肪·反弹\n非手术LAMS', msg: '증상상담:다이어트를 해도 살이 안 빠진다' },
          { title: '👗 穿衣时某部位让我在意', desc: '体型矫正·体型线条\n部位脂肪去除', msg: '증상상담:옷 입을 때 특정 부위가 신경 쓰인다' },
          { title: '🔬 想不手术去除脂肪', desc: '非手术LAMS\n10分钟·无切口', msg: '증상상담:수술 없이 지방을 빼고 싶다' },
        ],
      },
      ja: {
        hospital: [
          { title: '😣 ニキビがたくさんある', desc: '顔・背中・胸のニキビ\n皮脂・毛穴の問題', msg: '증상상담:여드름이 많이 난다' },
          { title: '🌑 肌がくすんで色素が出た', desc: 'シミ・そばかす・色素沈着\n肌トーン改善', msg: '증상상담:피부가 칙칙하고 색소가 생겼다' },
          { title: '📉 シワが増えて肌がたるんだ', desc: '老化・シワ・弾力低下\nリフティング必要', msg: '증상상담:주름이 늘고 피부가 처진다' },
          { title: '🔴 肌が赤くトラブルが多い', desc: '赤み・敏感肌・トラブル\n肌鎮静が必要', msg: '증상상담:피부가 붉고 트러블이 심하다' },
          { title: '🕳️ 毛穴が広く肌荒れがひどい', desc: '毛穴・肌質・角質\nスキンケアが必要', msg: '증상상담:모공이 넓고 피부결이 거칠다' },
          { title: '⚫ ほくろや傷跡が気になる', desc: 'ほくろ・傷跡・ニキビ跡\n除去相談', msg: '증상상담:점과 흉터가 신경 쓰인다' },
        ],
        plastic: [
          { title: '👁️ 目が小さい・二重がない', desc: '二重まぶた・目元矯正\n自然な目の整形', msg: '증상상담:눈이 작거나 쌍꺼풀이 없다' },
          { title: '👃 鼻が低い・気に入らない', desc: '鼻の整形・鼻筋・鼻先\n自然な鼻の整形', msg: '증상상담:코가 낮거나 마음에 안 든다' },
          { title: '😊 顔の輪郭が気になる', desc: '輪郭・頬骨・顎・フェイスライン\n輪郭整形', msg: '증상상담:얼굴 윤곽이 고민이다' },
          { title: '💉 ボトックス・フィラーが気になる', desc: 'シワ・ボリューム・リフティング\n非手術治療', msg: '증상상담:보톡스와 필러가 궁금하다' },
          { title: '🏋️ 豊胸手術を考えている', desc: '豊胸・縮小・リフティング\n胸の整形', msg: '증상상담:가슴 성형이 고민이다' },
        ],
        urology: [
          { title: '🚽 頻尿で困っている', desc: '頻尿・過活動膀胱\n前立腺の問題の可能性', msg: '증상상담:소변이 자주 마렵다' },
          { title: '😣 排尿時に痛みがある', desc: '尿路感染・膀胱炎\n専門医の診断が必要', msg: '증상상담:소변볼 때 통증이 있다' },
          { title: '💪 男性の健康が心配', desc: '男性機能・ホルモン\n泌尿器科の健康相談', msg: '증상상담:남성 건강이 걱정된다' },
          { title: '🔬 前立腺が心配', desc: '前立腺肥大・前立腺がん\n定期検診を推奨', msg: '증상상담:전립선이 걱정된다' },
        ],
        obgyn: [
          { title: '📅 生理が不規則', desc: '生理不順・無月経\nホルモンバランスの乱れ', msg: '증상상담:생리가 불규칙하다' },
          { title: '🤰 妊活中', desc: '産前検診・不妊\n妊娠準備相談', msg: '증상상담:임신 준비 중이다' },
          { title: '🌡️ 更年期症状がある', desc: 'ほてり・不眠・うつ\n更年期治療相談', msg: '증상상담:갱년기 증상이 있다' },
          { title: '💊 腟炎・おりものがある', desc: '腟炎・おりもの・かゆみ\n女性の健康相談', msg: '증상상담:질염과 냉대하가 있다' },
        ],
        psychiatry: [
          { title: '😔 気分が落ち込んで無気力', desc: 'うつ・無気力・意欲低下\n専門医への相談が必要', msg: '증상상담:우울하고 무기력하다' },
          { title: '😰 不安でパニックになる', desc: '不安障害・パニック発作\nパニック障害治療', msg: '증상상담:불안하고 공황이 온다' },
          { title: '😴 眠れない', desc: '不眠症・睡眠障害\n睡眠治療相談', msg: '증상상담:잠을 잘 못 잔다' },
          { title: '🧠 集中できず落ち着かない', desc: 'ADHD・集中力低下\n精密検査相談', msg: '증상상담:집중이 안 되고 산만하다' },
          { title: '😤 ストレスがひどい', desc: 'バーンアウト・ストレス\n心理相談が必要', msg: '증상상담:스트레스가 심하다' },
        ],
        dental: [
          { title: '🥶 歯がしみて痛い', desc: '虫歯・神経治療・知覚過敏\n早めの受診が必要', msg: '증상상담:치아가 시리고 아프다' },
          { title: '🩸 歯茎が腫れて出血する', desc: '歯肉炎・歯周炎\n歯茎治療が必要', msg: '증상상담:잇몸이 붓고 피가 난다' },
          { title: '😬 歯並びが悪い', desc: '歯列矯正・乱杭歯\n矯正相談', msg: '증상상담:치아가 고르지 않다' },
          { title: '🦷 インプラントが必要', desc: '欠損歯・インプラント\nインプラント相談', msg: '증상상담:임플란트가 필요하다' },
          { title: '🟡 歯が黄ばんでいる', desc: '歯の変色・ホワイトニング\nホワイトニング治療相談', msg: '증상상담:치아가 누렇다' },
        ],
        obesity: [
          { title: '🍔 お腹の脂肪が気になる', desc: 'お腹・内臓脂肪\n脂肪吸引・LAMS相談', msg: '증상상담:복부 살이 고민이다' },
          { title: '💪 二の腕が太くて気になる', desc: '二の腕の脂肪\nLAMS・脂肪吸引相談', msg: '증상상담:팔뚝이 굵어서 고민이다' },
          { title: '🦵 太ももが太くて気になる', desc: '太もも・ふくらはぎ脂肪\nLAMS・脂肪吸引相談', msg: '증상상담:허벅지가 두꺼워서 고민이다' },
          { title: '😓 ダイエットしても痩せない', desc: '局所脂肪・リバウンド\n非手術LAMS', msg: '증상상담:다이어트를 해도 살이 안 빠진다' },
          { title: '👗 服を着るとき特定の部位が気になる', desc: 'ボディシェイプ・ボディライン\n部位別脂肪除去', msg: '증상상담:옷 입을 때 특정 부위가 신경 쓰인다' },
          { title: '🔬 手術なしで脂肪を取りたい', desc: '非手術LAMS\n10分施術・切開なし', msg: '증상상담:수술 없이 지방을 빼고 싶다' },
        ],
      },
    };
